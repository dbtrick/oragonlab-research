            ...
            <div className="container">
                <div className="grid gap-9 lg:grid-cols-2">
                    <div className="flex flex-col gap-5">
                        ...
                        <h1 className="text-4xl font-medium text-balance lg:text-5xl">Complete Compliance & Security Readiness</h1>
                        <p className="text-lg text-muted-foreground">
                            Stay compliant with privacy and healthcare regulations. Our platform meets GDPR and HIPAA requirements, providing data
                    ...
                    <div className="rounded-2xl border border-border bg-muted/50">
                        <div className="relative overflow-hidden border-b border-border p-6 lg:px-8 lg:py-11">
                            <div>
                                <h2 className="text-xl font-medium lg:text-2xl">Automated audit trails</h2>
                        ...
                        <div className="relative overflow-hidden p-6 lg:px-8 lg:py-11">
                            <div>
                                <h2 className="text-xl font-medium lg:text-2xl">Compliance monitoring</h2>
                                <p className="mt-2 w-3/4 pr-10 text-sm text-muted-foreground md:text-base">
                        ...
                        <div className="relative overflow-hidden border-t border-border p-6 lg:px-8 lg:py-11">
                            <div>
                                <h2 className="text-xl font-medium lg:text-2xl">Regulatory reporting</h2>
                                <p className="mt-2 w-3/4 pr-10 text-sm text-muted-foreground md:text-base">
